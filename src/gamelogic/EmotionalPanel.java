 ...
 *
 */
public class EmotionalPanel extends JPanel {
     ...
     */
    public EmotionalPanel(Tetris tetris) {
        this.tetris = tetris;
        ...
        TextField hostPort = new TextField("9999");
    ...
    public void paintComponentt(Graphics g) {
